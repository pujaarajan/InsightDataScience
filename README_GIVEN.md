# Table of Contents
1. [Problem](README_GIVEN.md#problem)
2. [Input Dataset](README_GIVEN.md#input-dataset)
3. [Instructions](README_GIVEN.md#instructions)
4. [Output](README_GIVEN.md#output)
5. [Tips on getting an interview](README_GIVEN.md#tips-on-getting-an-interview)
6. [Instructions to submit your solution](README_GIVEN.md#instructions-to-submit-your-solution)
7. [FAQ](README_GIVEN.md#faq)
8. [Questions?](README_GIVEN.md#questions?)
