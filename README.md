...
The primary purpose of this code is:
...
**3. Perform data analysis. See analysis.py.**
...
NOTE: Normally I would commit more, but I didn't want to put my code online until I was ready to submit because i didn't want people to steal it.
